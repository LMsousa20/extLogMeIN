...
function tabelasEmEspera() {
    ...
    console.log(tabelaFila.children[2])
    console.log(tabelaFila.children[4])
    ...
    if (quantColuna <= 6) {
        ...
        <th align="center" style="width: 236px">
        <div class="headerCellContainer">
        <div> Descrição </div>
        </div>
        </th>
    ...
    for(let t=1; t< tabelaLinha.children.length; t++){
        ...
        tabelaLinha.children[t].innerHTML+= `<td>${empresaFilter}</td>`
